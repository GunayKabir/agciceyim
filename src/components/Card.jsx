...
<div
  className="w-full max-w-[230px] sm:max-w-[220px] md:max-w-[220px] lg:max-w-[250px] rounded-md shadow-md bg-white text-gray-800 border relative cursor-pointer"
  onClick={goToDetail}
>
...
<img
  src={product.img}
  alt={product.name}
  className="object-cover object-center w-full rounded-t-md h-48 sm:h-52 md:h-56"
/>
...
<div className="flex justify-center">
  <button
    ...
    className="w-full sm:w-40 px-3 py-2 rounded-full bg-cyan-500 hover:bg-cyan-600 text-white text-sm font-semibold transition-colors duration-300"
  >
    Səbətə
  </button>
</div>
